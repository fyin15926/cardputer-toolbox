...
2026-05-23 提升 A线刷新与播放波峰后烧录成功记录：
```text
Serial port COM3
Chip is ESP32-S3
Sketch uses 1144956 bytes (87%)
Global variables use 73972 bytes (22%)
Wrote 1145344 bytes
Hash of data verified.
Hard resetting with RTC WDT...
```

2026-05-23 播放 A线 60 柱快速抽样后烧录成功记录：
```text
Serial port COM3
Chip is ESP32-S3
Sketch uses 1145220 bytes (87%)
Global variables use 73972 bytes (22%)
Wrote 1145600 bytes
Hash of data verified.
Hard resetting with RTC WDT...
...
2026-05-23 重要录音目录与 Ctrl+Enter 标记后烧录成功记录：
```text
Serial port COM3
Chip is ESP32-S3
Sketch uses 1146476 bytes (87%)
Global variables use 75220 bytes (22%)
Wrote 1146864 bytes
Hash of data verified.
Hard resetting with RTC WDT...
```

2026-05-23 三列列表与播放 A线低卡顿预览后烧录成功记录：
```text
Serial port COM3
Chip is ESP32-S3
Sketch uses 1147508 bytes (87%)
Global variables use 76476 bytes (23%)
Wrote 1147888 bytes
Hash of data verified.
Hard resetting with RTC WDT...
```
